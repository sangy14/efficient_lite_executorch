import torch
from export_xnnpack import export_all_models, patch_batch_norm_for_fp32
...
with patch_batch_norm_for_fp32():
    ...
    for node in ep.graph.nodes:
        if 'tensor_meta' in node.meta:
            ...
            if list(shape) == [1, 160, 28, 40] or list(shape) == [1, 160, 40, 40] or list(shape) == [1, 160, 14, 20] or list(shape) == [1, 160, 20, 20]:
