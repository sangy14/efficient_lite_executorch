...
def load_pytorch_efficientdet_lite4(device='cpu', model_dir=None):
    ...
    if model is None:
        ...
        try:
            from effdet import create_model
            model = create_model('tf_efficientdet_lite0', pretrained=True, bench_task="predict", image_size=(320, 320))
            model.to(device)
...
# ================================================================
def main():
    parser = argparse.ArgumentParser(description='Evaluate EfficientDet-Lite0 Object Detection Model')
    # Required arguments
    parser.add_argument('--data-path', type=str, required=True,default='coco_images',help='Path to COCO images directory')
    parser.add_argument("--model-dir", type=str, default="efficientdet_lite0_xnnpack_models",
    ...
    parser.add_argument("--img-size", type=int, default=320,
                        help="Input image size (320 for Vulkan stability)")
