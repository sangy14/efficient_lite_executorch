...
def load_pytorch_efficientdet_lite4(device='cpu', model_dir=None):
    ...
    if model is None:
        ...
        try:
            from effdet import create_model
            model = create_model('tf_efficientdet_lite4', pretrained=True, bench_task="predict", image_size=(320, 320))
            model.to(device)
...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default="efficientdet_lite4_vulkan_320_models",
