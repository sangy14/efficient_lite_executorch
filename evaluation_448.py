...
def get_model_size_mb(model):
    ...
    return size_mb
def load_pytorch_efficientdet_lite4(device='cpu', model_dir=None, img_size=448):
    """
    ...
    if model is None:
        ...
        try:
            from effdet import create_model
            model = create_model('tf_efficientdet_lite4', pretrained=True, bench_task="predict", image_size=(img_size, img_size))
            model.eval()
            model.to(device)
...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default="efficientdet_lite4_448_models",
                        help="Directory containing .pte models")
    parser.add_argument("--annotations", type=str, default="coco/annotations/instances_val2017.json",
                        help="Path to COCO annotations file")
    parser.add_argument("--batch-size", type=int, default=1)
    parser.add_argument("--img-size", type=int, default=448,
                        help="Input image size (448 for Lite4 at this resolution)")
    ...
    model_dir=args.model_dir, img_size=args.img_size)
